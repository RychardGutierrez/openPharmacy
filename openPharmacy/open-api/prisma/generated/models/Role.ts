...
export type RoleOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"name" | "description", ExtArgs["result"]["role"]>
...
export interface RoleDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const roleWithDescriptionOnly = await prisma.role.findMany({ select: { description: true } })
   * 
   */
   ...
   * const roleWithDescriptionOnly = await prisma.role.createManyAndReturn({
   ...
   * const roleWithDescriptionOnly = await prisma.role.updateManyAndReturn({
   *   select: { description: true },
   *   where: {
   *     // ... provide filter here
   *   },
